package com.rds.cursomc.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNoFound(ObjectNotFoundException e, HttpServletRequest resquest){
	...
	public ResponseEntity<StandardError> dataIntegraty(DataIntegratyException e, HttpServletRequest resquest){
